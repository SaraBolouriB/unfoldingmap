...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		ellipse(50, 205, 13, 13);
		
		fill(color(0, 0, 255));
		ellipse(50, 230, 13, 13);
		
		fill(color(255, 0, 0));
		ellipse(50, 255, 13, 13);
//		
		fill(0, 0, 0);
		text("City Marker", 70, 105);
		text("Land Quake", 70, 128);
		text("Ocean Quake", 70, 152);
		textSize(14);
		text("Size ~ Magnitute", 45, 175);
		textSize(12);
		text("Shallow", 70, 203);
	...
	private void printQuakes() 
	{
        ...
        for (Marker cm : countryMarkers) {
        	...
        	for (Marker qm : quakeMarkers) {
    	    	...
    	    	if (em.isOnLand()) {
    	    		...
    	    		if ((String)lqm.getCountry() == name) {
     	    	    	int val = counter.get(name);
    	    	    	counter.put(name, ++val);
        ...
        System.out.println("country number:" + countryNum);
        ...
        System.out.println("Occean:" + (oceanEQ/countryNum));
		//        
